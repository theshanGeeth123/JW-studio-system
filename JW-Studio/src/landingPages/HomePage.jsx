    ...
    <div className="font-[Poppins] text-[var(--text-dark)] ">
      ...
      <header id="top" ref={headerRef} className="relative isolate">
        ...
        >
          ...
          >
            <li><button onClick={() => go('/home')} className="hover:opacity-90 hover:cursor-pointer" data-aos="fade-down" data-aos-duration="1500">Home</button></li>
          ...
          >
            ...
            >
              ...
              <div className="px-4 py-3 ">
                <button onClick={() => go('/home')} className="w-full text-left px-3 py-3 rounded-lg hover:bg-black/5">Home</button>
