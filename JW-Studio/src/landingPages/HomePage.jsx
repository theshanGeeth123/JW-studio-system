  ...
  >
    ...
    >
      ...
      <li >
        <a  href="/aboutPage" data-aos="fade-down" data-aos-duration="1800">
          About Us
        </a>
      </li>
      <li>
        <a href="/galleryPage" onClick={() => setMenuOpen(false)} data-aos="fade-down" data-aos-duration="2100">
          Gallery
        </a>
      </li>
      <li>
        <a href="/contactUs" onClick={() => setMenuOpen(false)} data-aos="fade-down" data-aos-duration="2400">
          Contact Us
        </a>
      </li>
    </ul>
