...
export default function NavBar() {
  ...
  return (
    <nav className="absolute inset-x-0 top-0 z-30 mx-auto w-full max-w-[1200px] px-4 py-4 flex items-center justify-between">
      {/* Desktop logo */}
      ...
      <ul
        ...
        className={[
          // base pill styling
          "rounded-[32px] bg-gray-900 backdrop-blur py-3 opacity-80",
          "text-white font-semibold",
          "items-center gap-5",
          "transition-all duration-300",
          "mt-[-30px]",
          "w-[50%] flex justify-between px-20",
          ...
          // Mobile positioning tweaks (unchanged)
          "sm:top-[70px]",
          "max-md:w-[50%] max-lg:text-[13px] max-lg:px-5 max-md:text-[10px] max-sm:text-[9px] max-sm:px-3 max-sm:mt-[8px] max-sm:ml-[25px]",
        ].join(" ")}
      >
        <li>
      ...
      {/* Hamburger (mobile only) — kept and hidden, as requested */}
      <button
        type="button"
